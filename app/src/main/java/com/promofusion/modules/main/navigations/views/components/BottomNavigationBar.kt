package com.promofusion.modules.main.navigations.views.components
...
import com.promofusion.modules.main.navigations.models.NavigationRoutes
import com.promofusion.modules.main.navigations.models.NavigationType
import com.promofusion.modules.navigations.views.components.BottomNavigationItemContainer
...
fun BottomNavigationBar(
    ...
    if (currentDestination?.route?.startsWith(MainNavigation.Default.route) == true)
        NavigationBar {
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                NavigationRoutes.forEachIndexed { _, item ->
                            ...
                            NavigationBarItem(
                                ...
                                icon = {
                                    (if (currentDestination.hierarchy.any { it.route == item.route }) item.selectedIcon
                                        ...
                                        ?.let {
                                            Icon(
                                                imageVector = it, contentDescription = item.title
                                            )
                                        }
                                },
                                modifier = Modifier
